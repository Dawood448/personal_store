                                        ...
                                        onTap: () async {
                                          ...
                                          await itemcolorcontroller
                                            ...
                                            if (itemcolorcontroller
                                              ...
                                              // checking123
                                              // int rightsvalue= 1;
                                              int rightsvalue = GetStorage()
                                                  .read('RateChange');
                                              Get.log(
                                                  '____rightsvalue is : ${rightsvalue}');
                                              AwesomeDialog(
                                                context: context,
                                              ...
                                              ElevatedButton(
                                                  onPressed: () async {
                                                    final GetStorage storage =
                                                        GetStorage();
                                                    Get.log(
                                                        '____Color name : ${widget.ColorName}');
                                                    Get.log(
                                                        '______ItemId  :             ${ItemId}');
                                                    String scannedColorName =
                                                        widget.ColorName;
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            content: Container(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  Text(
                                                                      'Item with the same color name and ID already exists.'),
                                                                  TextField(
                                                                    controller:
                                                                        _updatedquantity,
                                                                    decoration: InputDecoration(
                                                                ...
                                                                onPressed: () {
                                                                  ...
                                                                  double
                                                                      ...
                                                                      double.parse(
                                                                          existingSalePrice);
                                                                  Get.log(
                                                                      '____existing ${existingSalePrice} ');
                                                                  // Update the quantity locally and close the dialogue
                                                                  String
                                                                      newQuantity =
                                                                      _updatedquantity
