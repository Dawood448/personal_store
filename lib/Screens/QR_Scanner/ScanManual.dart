...
class _ScanManualState extends State<ScanManual> {
  ...
  tempfunc() async {
    ...
    await qRscanController.getQRData(qr_code: _scanBarcode);
  }
  ...
  Future<void> scanQR() async {
    ...
    try {
      ...
      print('barcode now  ${barcodeScanRes}');
  ...
  void _afterDialogClosed() async {
    print("Function called after closing the dialog.");
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          a = true;
                          print('vlue of a is ${a}');
                          while (a == true) {
                            print('first time ${_scanBarcode}');
                            ...
                            await itemDetailsbyCodeController
                                .getitemdetailsbyCode(
                                    id: controller
                                        .itemDetailedByQrModel!.data!.itemId,
                                            ...
                                            : Container(
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text(
                                                        '${itemDetailsbyCodeController.list.data!.lastSalePrice}',
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontSize: 18,
                                                            fontWeight:
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Center(
                                                          child: Row(
                                                            children: [
                                                              //dd item process starts here
                                                              ElevatedButton(
                                                                  onPressed:
                                                                      () async {
                                                                    print(
                                                                        'Entered in add item now');
                                                                    // _scanBarcode='';
                                                                    print(
                                                                        'HELLO 123');
                                                                    ...
                                                                    String
                                                                        ...
                                                                        qRscanController!
                                                                            ...
                                                                            .data!
                                                                            .colorName;
                                                                    int? scannedItemId = qRscanController!
                                                                        .itemDetailedByQrModel!
                                                                        .data!
                                                                        .itemId;
                                                                    ...
                                                                    if (matchingIndex !=
                                                                      ...
                                                                      double
                                                                          newSalePrice =
                                                                          double.parse(newSalePriceController
                                                                              .text
                                                                              .toString());
                                                                      if (rightsvalue ==
                                                                          0) {
                                                                        controller
                                                                            .list1 = [
                                                                          {
                                                                            ...
                                                                            'CustomerName':
                                                                                widget.customerName,
                                                                            'itemID':
                                                                                qRscanController.itemDetailedByQrModel!.data!.itemId,

                                                                            'itemName':
                                                                                qRscanController.itemDetailedByQrModel!.data!.itemName,
                                                                            'urduName':
                                                                                qRscanController.itemDetailedByQrModel!.data!.urduName,
                                                                            'colorName':
                                                                                qRscanController.itemDetailedByQrModel!.data!.colorName,
                                                                            'colorID':
                                                                                qRscanController.itemDetailedByQrModel!.data!.colorId,
                                                                            'salePrice':
                                                                                newPrice,
                                                                            'qty':
                                                                                int.parse(quantitycontroller.text.toString()),
                                                                            'itemNote':
                                                                                itemnotecontroller.text.toString(),
                                                                            'grossValue':
                                                                                quantity * newPrice,
                                                                          }
                                                                        ];
