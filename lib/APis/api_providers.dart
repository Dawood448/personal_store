...
class Api_Provider {
  ...
  Future<SaveStoreTransferModel?> SaveStoreTransferAPI({
    ...
    Get.log("Save Store Body is  ${body}");
  ...
  Future<SaveShopSale?> saveShopSaleAPI({
    ...
    int userid = GetStorage().read('SalesmanId');
    //changing required
    String url =
        'http://qadrishopsaleapi.qeperpsol.com/api/Invoice/saveshopsale?userid=${userid}';
    // String url =
    ...
    var body = jsonEncode(req);
    Get.log("my save shop data is ${body}");
    Map<String, String> headers = {
      //'accept': '*/*',
      'Authorization':
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._QYxFcUOaAn_Y5ZSLppRlA53qOjvVhR6yUGz4opR0Xk',
  ...
  //chnging required
  Future<GetdetailsbybCodeModel?> getItemDetailsbyCode(
      {required int? id, required int detailedCode}) async {
    String url =
